<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation_Layer/Forms/Doctor/Doctor.Master" AutoEventWireup="true" CodeBehind="PastAppointments.aspx.cs" Inherits="My_Clinic_2024_IFS303E.Presentation_Layer.Forms.Doctor.PastAppointments" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <!-- Include SweetAlert CSS and JS if not already included in Master page -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.css">
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.all.min.js"></script>
    <link href="../../Styles/PastAppointments.css" rel="stylesheet" />
</asp:Content>
     ...
     <div class="w3-container">
         ...
         <asp:GridView ID="GridViewAppointments" runat="server" AutoGenerateColumns="False" CssClass="grid-view" >
             <Columns>
                 ...
                 <asp:TemplateField>
                     <ItemTemplate>
                         <asp:Button ID="btnCancel" runat="server" Text="Remove" CommandName="CancelAppointment" CommandArgument='<%# Eval("AppointmentID") %>' CssClass="w3-button w3-red" />
