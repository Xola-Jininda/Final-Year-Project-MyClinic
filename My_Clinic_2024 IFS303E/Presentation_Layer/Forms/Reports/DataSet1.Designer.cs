...
namespace My_Clinic_2024_IFS303E.Presentation_Layer.Forms.Reports {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class PaymentDataTable : global::System.Data.TypedTableBase<PaymentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PaymentRow AddPaymentRow(string FullName, string CardNumber, string ExpiryDate, string CVV, string DeliveryAddress, System.DateTime PaymentDate, decimal AmountPaid, int UserId, string Status) {
        ...
        public partial class PaymentRow : global::System.Data.DataRow {
            ...
            public string DeliveryAddress {
                get {
                    return ((string)(this[this.tablePayment.DeliveryAddressColumn]));
                }
                set {
                    this[this.tablePayment.DeliveryAddressColumn] = value;
                }
            }
...
namespace My_Clinic_2024_IFS303E.Presentation_Layer.Forms.Reports.DataSet1TableAdapters {
    ...
    public partial class PaymentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Payment] ([FullName], [CardNumber], [ExpiryDate], [CVV], [DeliveryAddress], [PaymentDate], [AmountPaid], [UserId], [Status]) VALUES (@FullName, @CardNumber, @ExpiryDate, @CVV, @DeliveryAddress, @PaymentDate, @AmountPaid, @UserId, @Status)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Payment] SET [FullName] = @FullName, [CardNumber] = @CardNumber, [ExpiryDate] = @ExpiryDate, [CVV] = @CVV, [DeliveryAddress] = @DeliveryAddress, [PaymentDate] = @PaymentDate, [AmountPaid] = @AmountPaid, [UserId] = @UserId, [Status] = @Status WHERE (([PaymentId] = @Original_PaymentId))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["MyClinicConnectionString6"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PaymentId, FullName, CardNumber, ExpiryDate, CVV, DeliveryAddress, Payment" +
                "Date, AmountPaid, UserId, Status FROM dbo.Payment";
        ...
        public virtual int Insert(string FullName, string CardNumber, string ExpiryDate, string CVV, string DeliveryAddress, global::System.Nullable<global::System.DateTime> PaymentDate, global::System.Nullable<decimal> AmountPaid, global::System.Nullable<int> UserId, string Status) {
            if ((FullName == null)) {
        ...
        public virtual int Update(string FullName, string CardNumber, string ExpiryDate, string CVV, string DeliveryAddress, global::System.Nullable<global::System.DateTime> PaymentDate, global::System.Nullable<decimal> AmountPaid, global::System.Nullable<int> UserId, string Status, int Original_PaymentId) {
            if ((FullName == null)) {
                throw new global::System.ArgumentNullException("FullName");
            }
            else {
