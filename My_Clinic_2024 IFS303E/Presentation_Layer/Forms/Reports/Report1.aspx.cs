...
namespace My_Clinic_2024_IFS303E.Presentation_Layer.Forms.Reports
{
    public partial class Report1 : System.Web.UI.Page
    {
        ...
        //string con = ConfigurationManager.ConnectionStrings["MyClinicConnectionString"].ConnectionString;
        ...
        protected void btnPatientInfoRepor_Click(object sender, EventArgs e)
        {
            LoadReport("PatientInfo");
        }

        protected void btnEmergencyReport_Click(object sender, EventArgs e)
        {
            LoadReport("Emergency");
        }
